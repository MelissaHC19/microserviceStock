...
public final class DomainConstants {
    ...
    public static final String MIN_FIELD_SIZE_CATEGORY_LIST_MESSAGE = "The article must have at least one category associated.";
    public static final int MAX_FIELD_SIZE_CATEGORY_LIST = 3;
    public static final int MIN_FIELD_SIZE_CATEGORY_LIST = 1;
    public static final String MAX_FIELD_SIZE_CATEGORY_LIST_MESSAGE = "The article can't be associated to more than 3 categories.";
    ...
    public static final String INVALID_BRAND_ID_MESSAGE = "The brand ID must be greater than zero.";
